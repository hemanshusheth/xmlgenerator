...
namespace XmlGenerator.PopUp
{
    ...
    /// </summary>
    public partial class TextBoxPopUp
    {
        public TextBoxPopUp(IControl element)
        {
           InitializeComponent();
            Element = element;
        }
        ...
        private void comboBox1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            labelGrid= myGrid.CreateTextBox(count,labelGrid);
        }
        ...
        private Property GetProperty()
        {
            ...
            p.MessageValue = textBoxRegexValue.Text;
            return p;
        }
    }
}